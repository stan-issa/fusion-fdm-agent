...
| **Add lead-ins to pegs** | Pegs and pins with a square free end | A 0.5 mm chamfer on the tip — the other half of a lead-in, so an assembly swallows twice the misalignment |
